...
public static class Constantes
{
    ...
    public const string C_EnderecoApagarCliente = "ReiglassSOAP.asmx/CM_ApagarCliente";
    public const string C_EnderecoObterEtiqueta = "ReiglassSOAP.asmx/CM_ObterEtiqueta";
    public const string C_EnderecoAtualizarStatusEtiqueta = "ReiglassSOAP.asmx/CM_AtualizarStatus";
}
